...
import {
  Primitive
} from "./chunk-QHVUQGP4.js";
import "./chunk-PJEEZAML.js";
import {
  createSlot,
  useComposedRefs
} from "./chunk-ODNMOYHL.js";
import {
  require_jsx_runtime
...
var Slider = React9.forwardRef(
  (props, forwardedRef) => {
    ...
    const thumbRefs = React9.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React9.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React9.useRef(values);
...
var SliderHorizontal = React9.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
    ...
    const [slider, setSlider] = React9.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React9.useRef(void 0);
...
var SliderVertical = React9.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
...
var SliderImpl = React9.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React9.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React9.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React9.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection(props.__scopeSlider);
    const [thumb, setThumb] = React9.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index = React9.useMemo(
...
var SliderThumbImpl = React9.forwardRef(
  (props, forwardedRef) => {
...
var SliderBubbleInput = React9.forwardRef(
